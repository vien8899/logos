...
Public Class Rpt_StudentDrop
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LOGOS_SYS.Rpt_StudentDrop.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_StudentDrop
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_StudentDrop = New Rpt_StudentDrop()
        rpt.Site = Me.Site
        Return rpt
    End Function
