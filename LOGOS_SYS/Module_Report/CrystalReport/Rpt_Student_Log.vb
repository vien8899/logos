...
Public Class Rpt_Student_Log
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LOGOS_SYS.Rpt_Student_Log.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Student_Log
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Student_Log = New Rpt_Student_Log()
        rpt.Site = Me.Site
        Return rpt
    End Function
