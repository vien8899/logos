...
Public Class Rpt_Enroll_train
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LOGOS_SYS.Rpt_Enroll_train.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Enroll_train
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Enroll_train = New Rpt_Enroll_train()
        rpt.Site = Me.Site
        Return rpt
    End Function
