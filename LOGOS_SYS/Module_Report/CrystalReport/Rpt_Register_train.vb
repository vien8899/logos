...
Public Class Rpt_Register_train
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LOGOS_SYS.Rpt_Register_train.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Register_train
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Register_train = New Rpt_Register_train()
        rpt.Site = Me.Site
        Return rpt
    End Function
