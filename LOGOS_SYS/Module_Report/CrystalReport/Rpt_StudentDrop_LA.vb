...
Public Class Rpt_StudentDrop_LA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LOGOS_SYS.Rpt_StudentDrop_LA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_StudentDrop_LA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_StudentDrop_LA = New Rpt_StudentDrop_LA()
        rpt.Site = Me.Site
        Return rpt
    End Function
