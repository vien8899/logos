...
Public Class Rpt_StudentDebt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LOGOS_SYS.Rpt_StudentDebt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_StudentDebt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_StudentDebt = New Rpt_StudentDebt()
        rpt.Site = Me.Site
        Return rpt
    End Function
