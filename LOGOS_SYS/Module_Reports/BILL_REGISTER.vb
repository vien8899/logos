...
Public Class BILL_REGISTER
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LOGOS_SYS.BILL_REGISTER.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBILL_REGISTER
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BILL_REGISTER = New BILL_REGISTER()
        rpt.Site = Me.Site
        Return rpt
    End Function
