...
Public Class BILL_SELL_BOOK
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "LOGOS_SYS.BILL_SELL_BOOK.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBILL_SELL_BOOK
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BILL_SELL_BOOK = New BILL_SELL_BOOK()
        rpt.Site = Me.Site
        Return rpt
    End Function
